...
public class SaveGame implements Serializable {
    ...
    public void saveGameInsructions() {
        ...
        String save = Utils.scanner.nextLine();

        if (save.isEmpty()) {
            save = Utils.scanner.nextLine();
        }
    ...
    public void loadGameInstructions() {
        ...
        String load = Utils.scanner.nextLine();

        if (load.isEmpty()) {
            load = Utils.scanner.nextLine();
        }
    ...
    public void loadGame() {
        try {
            ...
            SaveGame loadedGame = (SaveGame) loadObj.readObject();
            loadObj.close();
